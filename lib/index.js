(function (global, factory) {
    ...
    class WindowLauncher extends React.Component {
        ...
        render() {
            ...
            return (jsxRuntime.jsxs("div", { ...divProps, style: { position: 'relative', overflow: 'hidden', ...divProps.style }, ref: (e) => {
                    if (e) {
                        launcher.setContainer(e);
                    }
                }, children: [this.props.children, this.state.openList.map((item) => {
